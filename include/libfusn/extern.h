...
#if !defined( _LIBFUSN_EXTERN_H )
#define _LIBFUSN_EXTERN_H

/* To export functions from the libfusn DLL define LIBFUSN_DLL_EXPORT
 * To import functions from the libfusn DLL define LIBFUSN_DLL_IMPORT
